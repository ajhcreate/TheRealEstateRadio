...
<script type="text/javascript" language="javascript" src="<?php echo JURI::root() . "components/com_guru/js/guru_modal.js"; ?>"></script>
<script>
    ...
    <div><!-- start main div-->
        <div class="table-of-contents">            
            <div class="uk-grid">
                ...
                <div class="col_title uk-width-large-1-2 uk-width-medium-1-2 uk-width-small-1-1 hidden-phone">
                    <?php
                ...
                <div class="uk-width-1-2 uk-hidden-small hidden-phone">
                    ...
                    <?php if ($user_id > 0 && $coursetype_details[0]["course_type"] != 0 && $coursetype_details[0]["lessons_show"] == 1 && $coursetype_details[0]["lesson_release"] > 0 && $not_show === TRUE && !in_array($user_id, $authors) && !$expired_license) { ?>
                        <div class="col_title pull-left uk-width-1-<?php echo intval($nr_columns); ?> ">
            ...
            foreach ($program_content as $key => $module) {
                ...
                <div class="guru-tabs chapter_wrap t_row">
                    ...
                    <!-- start module -->
                    <div class="guru-tab-title chapter_title clearfix test-1234">
                                ...
                                <div class = 'weblinks'>
                                    <div>
                                        <div class="teacher_links clearfix g_toolbar">
                                            <?php if ((trim($author->show_email) != "") && ($author->show_email == 1)) { ?>
        ...
        <div class="uk-hidden-small hidden-phone">
            <div class="guru-course-view" id="guru_tabs">
                <ul class="uk-tab uk-tab-grid uk-padding-remove" data-uk-tab>
                    <?php if (!empty($program_content) && $course_config->course_table_contents == "0") { ?>
                        <li id="li-tab1" class="uk-width-1-6 uk-active"><a href="#" onclick="javascript:changeGuruTab('tab1');
                                        return false;"><i class="uk-icon-bars"></i> <?php echo JText::_("GURU_TAB_TABLE_CONTENTS"); ?>....</a></li>
                                                                       <?php } ?>
                                                                       <?php if ($program->description != "" && $course_config->course_description_show == "0") { ?>
                        <li id="li-tab2" class="uk-width-1-6"><a href="#" onclick="javascript:changeGuruTab('tab2');
                                        return false;"><i class="uk-icon-file-text-o"></i> <?php echo JText::_("GURU_TAB_DESCRIPTION"); ?></a></li>
                                                             <?php } ?>
                                                             <?php if ($course_config->course_tab_price == "0" && !is_array(@$button)) { ?>
                        <li id="li-tab3" class="uk-width-1-6"><a href="#" onclick="javascript:changeGuruTab('tab3');
                                        return false;"><i class="uk-icon-usd"></i> <?php echo JText::_("GURU_BUY_PRICE"); ?></a></li>
                                                             <?php } ?>
                                                             <?php if (!empty($exercise) && $config->course_exercises == "0") { ?>
                        <li id="li-tab4" class="uk-width-1-6"><a href="#" onclick="javascript:changeGuruTab('tab4');
                                        return false;"><i class="uk-icon-folder-o"></i> <?php echo JText::_("GURU_EXERCISE_FILES"); ?></a></li>
                                                             <?php } ?>
                                                             <?php if ($course_config->course_author == "0") { ?>
                        <li id="li-tab5" class="uk-width-1-6">
                            <a href="#" onclick="javascript:changeGuruTab('tab5');
                                            return false;">
                    ...
                    <?php if ((!empty($requirements) || $program->pre_req != "" || $program->pre_req_books != "" || $program->reqmts != "") && ($course_config->course_requirements == "0") && !is_array(@$button)) { ?>
                        <li id="li-tab6" class="uk-width-1-6"><a href="#" onclick="javascript:changeGuruTab('tab6');
                                        return false;"><i class="uk-icon-info"></i> <?php echo JText::_("GURU_TAB_REQUIREMENTS"); ?></a></li>
                                                             <?php } ?>
                </ul>
