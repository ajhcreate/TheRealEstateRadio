...
$path = JPATH_SITE.DIRECTORY_SEPARATOR."components".DIRECTORY_SEPARATOR."com_guru".DIRECTORY_SEPARATOR."views".DIRECTORY_SEPARATOR."guruprograms".DIRECTORY_SEPARATOR."tmpl".DIRECTORY_SEPARATOR."tabs.php";
require_once($path);
                ...
                <div class="uk-width-1-1 uk-width-medium-1-3">
                    ...
                    <div class="gru-cover-purchase-btn">
                        ...
                        <?php
							...
							elseif($need_buy){
						?>
                                <a class="uk-button uk-button-success uk-button-large" href="<?php echo JURI::root()."index.php?option=com_guru&view=guruPrograms&task=buy_action&course_id=".$course_id."&Itemid=".intval($itemid); ?>">
                                    <i class="uk-icon-check"></i>
                                    <?php echo JText::_("GURU_TAKE_COURSE"); ?>
                                </a>
                        <?php
