...
<div class="uk-grid" data-uk-grid-margin>
	...
	<div class="uk-width-medium-3-4 <?php if($view->params->get('template.item_sidebar_alignment') == 'left') echo 'uk-push-1-4'; ?>">
	...
	<div class="uk-width-medium-1-4 <?php if($view->params->get('template.item_sidebar_alignment') == 'left') echo 'uk-pull-3-4'; ?>">
