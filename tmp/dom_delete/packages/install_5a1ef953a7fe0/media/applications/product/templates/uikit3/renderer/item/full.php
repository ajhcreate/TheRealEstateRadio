...
<div class="<?php echo 'uk-align-'.$view->params->get('template.item_media_alignment').($view->params->get('template.item_media_alignment') == "left" || $view->params->get('template.item_media_alignment') == "right" ? '@m' : ''); ?>">
