...
<?php if ($this->errors): ?>
	...
	<div class="uk-alert uk-alert-primary"><?php echo $msg; ?></div>
<?php endif; ?>
...
<form id="item-submission" action="<?php echo JRoute::_($this->app->route->submission($this->submission, $this->type->id, null, $this->item->id, $this->redirectTo)); ?>" method="post" name="submissionForm" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<div class="uk-alert uk-alert-primary"><?php echo JText::_('REQUIRED_INFO'); ?></div>

	<div class="uk-margin">
		<button type="submit" id="submit-button" class="uk-button uk-button-default"><?php echo $this->item->id ? JText::_('Save') : JText::_('Submit Item'); ?></button>
