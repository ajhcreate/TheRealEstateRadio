...
<div id="offlajn-ajax-search<?php echo $module->id; ?>">
  ...
  <?php
    ...
    if($params->get('targetsearch', 0) == 6) {
    ...
    } elseif($params->get('targetsearch', 0) == 8) {
      ...
      $formUrl = "index.php?option=com_adsmanager&view=result";
    } else if($params->get('targetsearch', 0) == 4) {
      $formUrl = "index.php?option=com_jshopping&controller=search&task=result";
    }    
  ?>
