...
if(version_compare(JVERSION,'1.6.0','l'))
  defined('OFFLAJNCOMPAT') or define( 'OFFLAJNCOMPAT', JPATH_SITE.'/plugins/system/compat/libraries');
else{
  defined('OFFLAJNCOMPAT') or define( 'OFFLAJNCOMPAT', JPATH_SITE.'/plugins/system/offlajnjoomla3compat/compat/libraries');
