...
<script type="text/javascript" language="javascript">
	function editquestion (qid, id) {
		...
		if (document.adminForm.text.value=='') {
			...
			window.parent.document.getElementById('tdq'+qid).innerHTML = '<a style="color:#666666!important; text-decoration:underline !important;" class="modal" rel="{handler: \'iframe\', size: {x: 770, y: 400}}" href="index.php?option=com_guru&controller=guruQuiz&task=editquestion&no_html=1&cid[]='+<?php echo $data_get['cid'][0]; ?>+'&qid='+qid+'">'+document.getElementById('text').value+'</a>';
