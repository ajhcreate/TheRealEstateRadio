...
<script language="javascript" type="text/javascript">
	...
	/*Joomla.submitbutton = function(pressbutton){
		...
		if (pressbutton == 'save' || pressbutton == 'apply'){
			...
			if(parseInt(form['author']).value == 0){
				alert( "<?php echo JText::_("GURU_SELECT_TEACHER");?>" );
				return false;
			}
			else{
				//---------------------------------
	...
	$(document).click(function(e){
		if ($(e.target).attr('id') != 'guru-dropdown-toggle' && $(e.target).attr('id') != 'icon-bell' && $(e.target).attr('id') != 'badge-important' && $(e.target).attr('id') != 'new-options-button2'){
...
<form action="index.php" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="<?php echo $class_message; ?>"><a href="#message" data-toggle="tab"><?php echo JText::_('GURU_PASS_FAIL_MESSAGE');?></a></li>
...
<form action="index.php" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
    ...
    <ul class="nav nav-tabs">
            ...
            <li><a href="#message2" data-toggle="tab"><?php echo JText::_('GURU_PASS_FAIL_MESSAGE');?></a></li>
