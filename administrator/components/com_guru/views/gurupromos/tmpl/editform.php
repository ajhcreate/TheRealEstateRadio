                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <?php 
                                                    for($i=0; $i<count($courses); $i++){
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="checkbox" <?php if(isset($promo->courses_ids)&&(in_array($id,$courses_array))) { echo 'checked="checked"'; } ?> name="cid[]" value="<?php echo $id;?>" />
                                                                <span class="lbl"></span>
                                                            </td>	
                                                            <td>
                    ...
                    <div class="span12">
                        <div class="row-fluid">
                            <div class="control-group">
                              ...
                              <div class="controls">
                              	<div class="pull-left">
                                  <input type="text" size="10" name="codelimit" value="<?php echo $promo->codelimit; ?>"/>
                                </div>
                                <div class="pull-left">&nbsp;&nbsp;&nbsp;		
                    ...
                    <div class="span12">
                        <div class="row-fluid">
                            <div class="control-group">
                              ...
                              <div class="controls">
                              	<div class="pull-left">
                                  <input type="text" size="10" name="discount" value="<?php echo $promo->discount;?>"/>&nbsp;&nbsp&nbsp;&nbsp
                                </div>
                                <div class="pull-left">
