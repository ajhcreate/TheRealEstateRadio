			...
			?>
				...
				?>
                   ...
                   <td>
                        <?php
                            if($currencypos == 0){
                                echo JText::_("GURU_CURRENCY_".$value["currency"])." ".number_format($value["amount_paid_author"],2);
                            }
                            else{
                                echo number_format($value["amount_paid_author"],2)." ".JText::_("GURU_CURRENCY_".$value["currency"]);
                            }
                        ?>
                   </td>
                    <td>
			...
			?>
				<tr> 
					...
					<td>
						<?php
							if($currencypos == 0){
								echo JText::_("GURU_CURRENCY_".$details[$i]["currency"])." ".$details[$i]["price"];
							}
							else{
								echo $details[$i]["price"]." ".JText::_("GURU_CURRENCY_".$details[$i]["currency"]);
							}
						?>
				   </td>
				   <td>
						<?php
							if($currencypos == 0){
								echo JText::_("GURU_CURRENCY_".$details[$i]["currency"])." ".$details[$i]["price_paid"];
							}
							else{
								echo $details[$i]["price_paid"]." ".JText::_("GURU_CURRENCY_".$details[$i]["currency"]);
							}
						?>
				   </td>
				   <td>
				   ...
				   <td>
						<?php 
							if($currencypos == 0){
								echo JText::_("GURU_CURRENCY_".$details[$i]["currency"])." ".number_format($details[$i]["amount_paid_author"],2);
							}
							else{
								echo number_format($details[$i]["amount_paid_author"],2)." ".JText::_("GURU_CURRENCY_".$details[$i]["currency"]);
							}
                        ?>
				   </td>
