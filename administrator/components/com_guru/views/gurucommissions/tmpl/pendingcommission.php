...
<table class="sortable table table-striped adminlist table-bordered">
	...
	<?php
		...
		<tr> 
		   ...
		   <td>
				<?php echo '<a href="index.php?option=com_guru&controller=guruAuthor&task=edit&id='.$value["author_id"].'&hidemainmenu=1">'.@$teachername["0"].'</a>';?>
		   </td>
		   <td>
		   ...
		   <td>
            ...
            <td>
            	<?php 
					...
					?>
						<a class="g_btn-warning"  onClick = "document.PayPalPayment.business.value='<?php echo $paypal_email;?>'; document.PayPalPayment.currency_code.value='<?php echo $value["currency"];?>'; document.PayPalPayment.currency_code.value='<?php echo $value["currency"];?>'; document.PayPalPayment.business.value='<?php echo $paypal_email;?>'; document.PayPalPayment.item_name_1.value='<?php echo @$teachername["0"];?>'; document.PayPalPayment.amount_1.value='<?php echo number_format($amount_pending,2);?>'; document.PayPalPayment.custom.value='<?php echo $value["author_id"]."-".$value["course_id"]."-".$value["id"];?>'; document.PayPalPayment.submit();"><?php echo JText::_("GURU_PAY_WITH_PAYPAL"); ?></a>
					<?php
					  }
				  }
				  else{
