			...
			<?php 
                for($i = 0; $i < $n; $i++){
					...
					if($plugin["name"] == "Payment Processor [PayPal]"){
						$link = "index.php?option=com_plugins&view=plugins&filter_search=PayPal";
				   	}
					elseif($plugin["name"] == "Payment Processor [Offline]"){
						$link = "index.php?option=com_plugins&view=plugins&filter_search=Offline";
				   	}
				   	elseif($plugin["name"] == "Payment Processor [AuthorizeNet]"){
				   		$link = "index.php?option=com_plugins&view=plugins&filter_search=AuthorizeNet";
				   	}
				   	elseif($plugin["name"] == "PLG_GURUPAYMENT_PAYGATE"){
				   		$link = "index.php?option=com_plugins&view=plugins&filter_search=PayGate";
				   	...
				   	elseif($plugin["name"] == "PLG_GURUPAYMENT_PERCOMS"){
				   		$link = "index.php?option=com_plugins&view=plugins&filter_search=Percoms";
				   	...
				   	elseif($plugin["name"] == "PLG_GURUPAYMENT_STRIPE"){
				   		$link = "index.php?option=com_plugins&view=plugins&filter_search=Stripe";
