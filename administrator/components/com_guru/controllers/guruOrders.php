...
class guruAdminControllerguruOrders extends guruAdminController {
	...
	function productitem(){
		...
		$return .= 					'<table style="width:30%"><tr><td><div style="float: left;">					
										<span style="border: 1px solid rgb(204, 204, 204); padding: 0.2em; overflow: visible; height: 18px; display: block; width: 230px;" id="course_name_text_'.$generate_number.'">'.JText::_("GURU_SELECT_A_COURSE").'</span>
