...
class guruAdminControllerguruCommissions extends guruAdminController {
	...
	function pending(){
		JFactory::getApplication()->input->set("view", "gurucommissions");
		$p = JFactory::getApplication()->input->get("p", "0");
		$view = $this->getView("gurucommissions", "html");
	...
	function make_Paid(){
		...
		$app->redirect('index.php?option=com_guru&controller=guruCommissions&task=pending', $msg, $type);
	}
	function pendingOk(){
		$app = JFactory::getApplication('administrator');
	...
	function make_Paid_Top(){
		$app = JFactory::getApplication('administrator');
		$p = JFactory::getApplication()->input->get("p", "");
	...
	function delete(){
		...
		$app->redirect('index.php?option=com_guru&controller=guruCommissions&task=list', $msg, $type);
	}
