...
class guruAdminModelguruConfig extends JModelLegacy {
	...
	function store () {
		...
		$ctgslayout = JFactory::getApplication()->input->get("ctgslayout", "");
		$ctgscols = JFactory::getApplication()->input->get("ctgscols", "");
		$ctgs_image_size = JFactory::getApplication()->input->get("ctgs_image_size", "");
		$ctgs_image_size_type = JFactory::getApplication()->input->get("ctgs_image_size_type", "");
		$ctgs_image_alignment = JFactory::getApplication()->input->get("ctgs_image_alignment", "");
		$ctgs_wrap_image = JFactory::getApplication()->input->get("ctgs_wrap_image", "");
		$ctgs_description_length = JFactory::getApplication()->input->get("ctgs_description_length", "");
		$ctgs_description_type =JFactory::getApplication()->input->get("ctgs_description_type", "");
		$ctgs_description_mode = JFactory::getApplication()->input->get("ctgs_description_mode", "");
		$ctgs_description_alignment = JFactory::getApplication()->input->get("ctgs_description_alignment", "");
		$ctgs_read_more = JFactory::getApplication()->input->get("ctgs_read_more", "");
		$ctgs_read_more_align = JFactory::getApplication()->input->get("ctgs_read_more_align", "");
		$ctgs_show_empty_catgs = JFactory::getApplication()->input->get("ctgs_show_empty_catgs", "");
		...
		$ctgs_page_title = JFactory::getApplication()->input->get("ctgs_page_title", "");
		$ctgs_categ_name = JFactory::getApplication()->input->get("ctgs_categ_name", "");
		$ctgs_image = JFactory::getApplication()->input->get("ctgs_image", "");
		$ctgs_description = JFactory::getApplication()->input->get("ctgs_description", "");
		$ctgs_st_read_more = JFactory::getApplication()->input->get("ctgs_st_read_more", "");
		...
		//-----------------------------------------------------
		$ctg_image_size = JFactory::getApplication()->input->get("ctg_image_size", "");
		$ctg_image_size_type = JFactory::getApplication()->input->get("ctg_image_size_type", "");
		$ctg_image_alignment = JFactory::getApplication()->input->get("ctg_image_alignment", "");
		$ctg_description_length = JFactory::getApplication()->input->get("ctg_description_length", "");
		$ctg_description_type = JFactory::getApplication()->input->get("ctg_description_type", "");
		$ctg_description_mode = JFactory::getApplication()->input->get("ctg_description_mode", "");
		$ctg_description_alignment = JFactory::getApplication()->input->get("ctg_description_alignment", "");
		$ctgpage_array = array("ctg_image_size" => $ctg_image_size, "ctg_image_size_type" => $ctg_image_size_type, "ctg_image_alignment" => $ctg_image_alignment, "ctg_description_length" => $ctg_description_length, "ctg_description_mode" => $ctg_description_mode, "ctg_description_type" => $ctg_description_type, "ctg_description_alignment" => $ctg_description_alignment);
		$data["ctgpage"] = json_encode($ctgpage_array);
		
		$ctg_name = JFactory::getApplication()->input->get("ctg_name", "");
		$ctg_image = JFactory::getApplication()->input->get("ctg_image", "");
		$ctg_description = JFactory::getApplication()->input->get("ctg_description", "");
		$ctg_sub_title = JFactory::getApplication()->input->get("ctg_sub_title", "");
		...
		//-----------------------------------------------------
		$courseslayout = JFactory::getApplication()->input->get("courseslayout", "");
		$coursescols = JFactory::getApplication()->input->get("coursescols", "");
		$courses_image_size = JFactory::getApplication()->input->get("courses_image_size", "");
		$courses_image_size_type = JFactory::getApplication()->input->get("courses_image_size_type", "");
		$courses_image_alignment = JFactory::getApplication()->input->get("courses_image_alignment", "");
		$courses_wrap_image = JFactory::getApplication()->input->get("courses_wrap_image", "");
		$courses_description_length = JFactory::getApplication()->input->get("courses_description_length", "");
		$courses_description_type = JFactory::getApplication()->input->get("courses_description_type", "");
		$courses_description_mode = JFactory::getApplication()->input->get("courses_description_mode", "");
		$courses_description_alignment = JFactory::getApplication()->input->get("courses_description_alignment", "");
		$courses_read_more = JFactory::getApplication()->input->get("courses_read_more", "");
		$courses_read_more_align = JFactory::getApplication()->input->get("courses_read_more_align", "");
		...
		$courses_page_title = JFactory::getApplication()->input->get("courses_page_title", "");
		$courses_name = JFactory::getApplication()->input->get("courses_name", "");
		$courses_image = JFactory::getApplication()->input->get("courses_image", "");
		$courses_description = JFactory::getApplication()->input->get("courses_description", "");
		$courses_st_read_more = JFactory::getApplication()->input->get("courses_st_read_more", "");
		...
		//-----------------------------------------------------
		$course_image_size = JFactory::getApplication()->input->get("course_image_size", "");
		$course_image_size_type = JFactory::getApplication()->input->get("course_image_size_type", "");
		$course_image_alignment = JFactory::getApplication()->input->get("course_image_alignment", "");
		$course_wrap_image = JFactory::getApplication()->input->get("course_wrap_image", "");
		$show_course_image = JFactory::getApplication()->input->get("show_course_image", "");
		$show_course_studentamount = JFactory::getApplication()->input->get("show_course_studentamount", "");
		$course_author_name_show = JFactory::getApplication()->input->get("course_author_name_show", "");
		$course_released_date = JFactory::getApplication()->input->get("course_released_date", "");
		$duration = JFactory::getApplication()->input->get("duration", "");
		$quiz_status = JFactory::getApplication()->input->get("quiz_status", "0");
		$course_level = JFactory::getApplication()->input->get("course_level", "");
		$course_price = JFactory::getApplication()->input->get("course_price", "");
		$course_price_type = JFactory::getApplication()->input->get("course_price_type", "");
		$course_table_contents = JFactory::getApplication()->input->get("course_table_contents", "");
		$course_description_show = JFactory::getApplication()->input->get("course_description_show", "");
		$course_tab_price = JFactory::getApplication()->input->get("course_tab_price", "");
		$course_author = JFactory::getApplication()->input->get("course_author", "");
		$course_requirements = JFactory::getApplication()->input->get("course_requirements", "");
		$course_buy_button = JFactory::getApplication()->input->get("course_buy_button", "");
		$course_buy_button_location = JFactory::getApplication()->input->get("course_buy_button_location", "");
		$show_all_cloase_all = JFactory::getApplication()->input->get("show_all_cloase_all", "");
		$psgpage_array = array("course_image_size" => $course_image_size, "course_image_size_type" => $course_image_size_type, "course_image_alignment" => $course_image_alignment, "course_wrap_image" => $course_wrap_image, "course_author_name_show" => $course_author_name_show, "course_released_date" => $course_released_date, "course_level" => $course_level, "course_price" => $course_price, "course_price_type" => $course_price_type, "course_table_contents" => $course_table_contents, "course_description_show" => $course_description_show, "course_tab_price" => $course_tab_price, "course_author" => $course_author, "course_requirements" => $course_requirements, "course_buy_button" => $course_buy_button, "course_buy_button_location" => $course_buy_button_location, "show_course_image" => $show_course_image, "show_course_studentamount" => $show_course_studentamount,"show_all_cloase_all" => $show_all_cloase_all, "duration"=>$duration, "quiz_status"=>$quiz_status);
		$data["psgpage"] = json_encode($psgpage_array);
		
		$course_name = JFactory::getApplication()->input->get("course_name", "");
		$course_image = JFactory::getApplication()->input->get("course_image", "");
		$course_top_field_name = JFactory::getApplication()->input->get("course_top_field_name", "");
		$course_top_field_value = JFactory::getApplication()->input->get("course_top_field_value", "");
		$course_tabs_module_name = JFactory::getApplication()->input->get("course_tabs_module_name", "");
		$course_tabs_step_name = JFactory::getApplication()->input->get("course_tabs_step_name", "");
		$course_description = JFactory::getApplication()->input->get("course_description", "");
		$course_price_field_name = JFactory::getApplication()->input->get("course_price_field_name", "");
		$course_price_field_value = JFactory::getApplication()->input->get("course_price_field_value", "");
		$course_author_name = JFactory::getApplication()->input->get("course_author_name", "");
		$course_author_bio = JFactory::getApplication()->input->get("course_author_bio", "");
		$course_author_image = JFactory::getApplication()->input->get("course_author_image", "");
		$course_req_field_name = JFactory::getApplication()->input->get("course_req_field_name", "");
		$course_req_field_value = JFactory::getApplication()->input->get("course_req_field_value", "");
		$course_other_button = JFactory::getApplication()->input->get("course_other_button", "");
		$course_other_background = JFactory::getApplication()->input->get("course_other_background", "");
		...
		//-----------------------------------------------------
		$authorslayout = JFactory::getApplication()->input->get("authorslayout", "");
		$authorscols = JFactory::getApplication()->input->get("authorscols", "");
		$authors_image_size = JFactory::getApplication()->input->get("authors_image_size", "");
		$authors_image_size_type = JFactory::getApplication()->input->get("authors_image_size_type", "");
		$authors_image_alignment = JFactory::getApplication()->input->get("authors_image_alignment", "");
		$authors_wrap_image = JFactory::getApplication()->input->get("authors_wrap_image", "");
		$authors_description_length = JFactory::getApplication()->input->get("authors_description_length", "");
		$authors_description_mode = JFactory::getApplication()->input->get("authors_description_mode", "");
		$authors_description_type = JFactory::getApplication()->input->get("authors_description_type", "");
		$authors_description_alignment = JFactory::getApplication()->input->get("authors_description_alignment", "");
		$authors_read_more = JFactory::getApplication()->input->get("authors_read_more", "");
		$authors_read_more_align = JFactory::getApplication()->input->get("authors_read_more_align", "");
		...
		$authors_page_title = JFactory::getApplication()->input->get("authors_page_title", "");
		$authors_name = JFactory::getApplication()->input->get("authors_name", "");
		$authors_image = JFactory::getApplication()->input->get("authors_image", "");
		$authors_description = JFactory::getApplication()->input->get("authors_description", "");
		$authors_st_read_more = JFactory::getApplication()->input->get("authors_st_read_more", "");
		...
		//-----------------------------------------------------
		$author_image_size = JFactory::getApplication()->input->get("author_image_size", "");
		$author_image_size_type = JFactory::getApplication()->input->get("author_image_size_type", "");
		$author_image_alignment = JFactory::getApplication()->input->get("author_image_alignment", "");
		$author_wrap_image = JFactory::getApplication()->input->get("author_wrap_image", "");
		$author_description_length = JFactory::getApplication()->input->get("author_description_length", "");
		$author_description_type = JFactory::getApplication()->input->get("author_description_type", "");
		$author_description_alignment = JFactory::getApplication()->input->get("author_description_alignment", "");
		...
		$author_name = JFactory::getApplication()->input->get("author_name", "");
		$author_image = JFactory::getApplication()->input->get("author_image", "");
		$author_description = JFactory::getApplication()->input->get("author_description", "");
		$author_st_read_more = JFactory::getApplication()->input->get("author_st_read_more", "");
		//add new columns for teacher page in admin(confis->tab8)
		$teacher_aprove = JFactory::getApplication()->input->get("teacher_aprove", "");
		$teacher_group = JFactory::getApplication()->input->get("teacher_group", "");
		$teacher_add_media = JFactory::getApplication()->input->get("teacher_add_media", "");
		$teacher_edit_media = JFactory::getApplication()->input->get("teacher_edit_media", ""); 
		$teacher_add_courses = JFactory::getApplication()->input->get("teacher_add_courses", "");
		$teacher_approve_courses = JFactory::getApplication()->input->get("teacher_approve_courses", ""); 
		$teacher_edit_courses = JFactory::getApplication()->input->get("teacher_edit_courses", "");
		$teacher_add_quizzesfe = JFactory::getApplication()->input->get("teacher_add_quizzesfe", "");
		$teacher_edit_quizzesfe = JFactory::getApplication()->input->get("teacher_edit_quizzesfe", "");
		$teacher_add_students =  JFactory::getApplication()->input->get("teacher_add_students", "");
		$teacher_edit_students = JFactory::getApplication()->input->get("teacher_edit_students", "");
		//----------end new columns-----------
		...
		elseif($tab == "11"){
			...
			if(trim($license_number) == ""){
				$app->redirect("index.php?option=com_guru&controller=guruConfigs&tab=11", JText::_("GURU_EMPTY_LICENSE_NUMBER"), "error");
				die();
			}
			else{
				...
				if(isset($license_details) && trim($license_details) != ""){
					...
					if(isset($license_details["0"])){
						...
						// license not exists
						$app->redirect("index.php?option=com_guru&controller=guruConfigs&tab=11", JText::_("GURU_GET_LICENSE_HERE")." <a href='https://guru.ijoomla.com/pricing' target='_blank'>".JText::_("GURU_HERE")."</a>", "error");
						die();
					}
					...
					elseif(isset($license_details["expires"]) && trim($license_details["expires"]) != "" && trim($license_details["expires"]) != "0000-00-00 00:00:00"){
						...
						if($license_expires >= $now){
							...
							$app->redirect("index.php?option=com_guru&controller=guruConfigs&tab=11", JText::_("GURU_INVALID_LICENSE_NUMBER")." <a href='https://www.ijoomla.com/my-downloads43/licenses/42' target='_blank'>".JText::_("GURU_HERE")."</a>", "error");
							die();
						}
					}
				}
