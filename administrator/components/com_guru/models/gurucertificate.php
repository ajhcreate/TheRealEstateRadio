...
class guruAdminModelguruCertificate extends JModelLegacy {
	...
	function savedesigncert($t) {
		...
		$avg_cert = JFactory::getApplication()->input->get("avg_cert", "", "raw");
