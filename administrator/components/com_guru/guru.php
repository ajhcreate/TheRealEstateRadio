...
<div id="js-cpanel">
    ...
    ?>
		...
		<script src="<?php echo JURI::root(); ?>components/com_guru/js/jquery_1_11_2.js"></script>
		
		<script src="components/com_guru/js/jquery-dropdown.js"></script>
	<?php
        	if($controller == ""){
	?>
				<script src="components/com_guru/js/jquery.flot.js"></script>
				<script src="components/com_guru/js/jquery.flot.time.js"></script>
    <?php
	...
	?>	
    	<script src="components/com_guru/js/ace-elements.min.js"></script>
        <script src="components/com_guru/js/typeahead.jquery.min.js"></script>
		<script src="components/com_guru/js/ace.min.js"></script>
        
        <script src="components/com_guru/js/jquery.DOMWindow.js"></script>
        <script src="components/com_guru/js/open_modal_page.js"></script>
	<?php
...
<?php 
		...
		if($task !="guru_file_uploader" && $task != "getcoursecost" && $task != "export_button" && $task != "getplans" && $task != "setrenew" && $task != "setpromo" && $task != "checkExistingUser" && $task != "checkCommissionPlan" && $task != "addcourse_ajax" && $task != "publish_un_ajax" && $task != "delete_image_ajax" && $task != "saveOrderG" && $task != "saveOrderS" && $task != "deleteFinalQuiz" && $task != "deleteGroup" && $task != "deleteScreen" && $task != "delete_categ_image" && $task != "check_values" && $task != "delete_course_image" && $task != "ajax_request" && $task != "ajax_request2" && $task != "ajax_request3" && $task != "export" && $task != "saveOrderQuestions" && $task != "savequestionandclose"){
