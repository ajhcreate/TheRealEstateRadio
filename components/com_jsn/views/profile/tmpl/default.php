	...
	<div class="jsn-p-opt">
		<?php if (JFactory::getApplication()->input->get('back')=='1') : ?>
				...
				<a class="btn btn-xs btn-default" href="#" onclick="window.history.back();return false;">
						<i class="jsn-icon jsn-icon-share"></i> <?php echo JText::_('Back'); ?></a>
		<?php endif; ?>
		...
		<?php if (JFactory::getUser()->id != $this->data->id) :
			...
			if($contact=$db->loadResult()) : ?>
					<a class="btn btn-xs btn-default" href="<?php echo JRoute::_('index.php?option=com_contact&view=contact&id='.$contact,false);?>">
