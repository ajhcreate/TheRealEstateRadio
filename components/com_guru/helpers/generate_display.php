        ...
        if($layout == "1"){//mini profile
            ...
            if($wrap == "1"){//no wrap
                ...
                if($img_align == "0"){// left
                    ...
                    //	$return .= '<div class=" media '.$style_authors->authors_st_read_more.'" style="text-align:'.$read_align.'">'.'<a href="'.JRoute::_('index.php?option=com_guru&view=guruauthor&layout=view&cid='.$author->id."-".JFilterOutput::stringURLSafe($author->name)."&Itemid=".$item_id).'">'.JText::_("GURU_READ_MORE").'</a></div>';
                ...
                elseif($img_align == "1"){// right
                    ...
                    //$return .= '<div class="'.$style_authors->authors_st_read_more.'" style="text-align:'.$read_align.'">'.'<a href="'.JRoute::_('index.php?option=com_guru&view=guruauthor&layout=view&cid='.$author->id."-".JFilterOutput::stringURLSafe($author->name)."&Itemid=".$item_id).'">'.JText::_("GURU_READ_MORE").'</a></div>';
            ...
            if($layout == "1"){//mini profile
                ...
                if($wrap == "1"){//no wrap
                    ...
                    if($img_align == "0"){// left
                        ...
                        if($read_more == "0" && $edit_read_more == "0"){$rc ='<a class="btn readmore" href="'.JRoute::_('index.php?option=com_guru&view=guruPcategs&task=view&cid='.$course->id."-".$alias."&Itemid=".$item_id).'">'.JText::_("GURU_READ_MORE").'</a>';}
                    ...
                    elseif($img_align == "1"){// right
                        ...
                        if($read_more == "0" && $edit_read_more == "0"){
                            ...
                            $return .= '<div class="'.$style_categs->ctgs_st_read_more.'" style="text-align:'.$read_align.'">'.'<a class="btn readmore" href="'.JRoute::_('index.php?option=com_guru&view=guruPcategs&task=view&cid='.$course->id."-".$alias."&Itemid=".$item_id).'">'.JText::_("GURU_READ_MORE").'</a></div>';
