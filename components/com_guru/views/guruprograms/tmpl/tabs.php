                                        	...
                                        	<ul>
												<?php
													...
													foreach($lessons as $poz=>$lesson){
                                                        ...
                                                        $lesson = $model->getLessonDetails($program, $author, $lesson, $diff_date, $diff_start, $step_less, $start_date, $config, $lesson_details_for_quiz, $poz, $nr_lesson);
            ...
            <div class="guru-course-view" id="guru_tabs">
                <ul class="uk-tab uk-tab-grid uk-padding-remove" data-uk-tab>
                     <?php if(!empty($program_content) && $course_config->course_table_contents == "0"){?>
                            <li id="li-tab1" class="uk-width-1-6 uk-active"><a href="#" onclick="javascript:changeGuruTab('tab1'); return false;"><i class="uk-icon-bars"></i> <?php echo JText::_("GURU_TAB_TABLE_CONTENTS");?></a></li>
                     <?php }?>
                     <?php  if($program->description != "" && $course_config->course_description_show == "0"){?>
                                <li id="li-tab2" class="uk-width-1-6"><a href="#" onclick="javascript:changeGuruTab('tab2'); return false;"><i class="uk-icon-file-text-o"></i> <?php echo JText::_("GURU_TAB_DESCRIPTION");?></a></li>
                     <?php }?>
                     <?php if($course_config->course_tab_price == "0" && !is_array(@$button)){?>
                                <li id="li-tab3" class="uk-width-1-6"><a href="#" onclick="javascript:changeGuruTab('tab3'); return false;"><i class="uk-icon-usd"></i> <?php echo JText::_("GURU_BUY_PRICE");?></a></li>
                     <?php }?>
                     <?php if(!empty($exercise) && $config->course_exercises == "0"){?>
                                <li id="li-tab4" class="uk-width-1-6"><a href="#" onclick="javascript:changeGuruTab('tab4'); return false;"><i class="uk-icon-folder-o"></i> <?php echo JText::_("GURU_EXERCISE_FILES");?></a></li>
                     <?php }?>
                     ...
                     <?php if((!empty($requirements) || $program->pre_req!="" || $program->pre_req_books!="" || $program->reqmts!="") && ($course_config->course_requirements == "0") && !is_array(@$button)){?>
                                <li id="li-tab6" class="uk-width-1-6"><a href="#" onclick="javascript:changeGuruTab('tab6'); return false;"><i class="uk-icon-info"></i> <?php echo JText::_("GURU_TAB_REQUIREMENTS");?></a></li>
                     <?php }?>
            </ul>
