    ...
    function saveCourse(pressbutton){
        ...
        if (pressbutton == 'save' || pressbutton == 'apply') {
            ...
            else if(document.getElementById('startpublish').value != '' && document.getElementById('endpublish').value != '' && sDate > eDate)
            {
                ...
                document.getElementById("form_task").value = pressbutton;
                if(pressbutton=='apply') {submitform('apply');} else {submitform( pressbutton );}
            }
        }
        else{  
    ...
    function publishUn(i){
        ...
        var myAjax = new Request.HTML({
            ...
            onSuccess: function(data) {
                if(data[0].textContent.trim() == 'publish'){
                    element_id = "g_publish"+i;
                    document.getElementById(element_id).className = "icon-ok";
                }
                else if(data[0].textContent.trim() == 'unpublish'){
                    element_id = "g_publish"+i;
    ...
    ?>
            <form action="<?php echo JURI::root(); ?>index.php?option=com_guru?view=guruAuthor" class="uk-form uk-form-horizontal" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
                ...
                <ul data-uk-switcher="{connect:'#subnav-pill-content-1'}" data-uk-tab class="uk-tab uk-padding-remove">
                    ...
                    <li class=""><a href="#"><?php echo JText::_('GURU_PRODDESC'); ?></a></li>
                    <li class=""><a href="#"><?php echo JText::_('GURU_IMAGE_COVER'); ?></a></li>
                    <li class=""><a href="#"><?php echo JText::_('GURU_EXERCISE_FILES'); ?></a></li>
                    <li class=""><a href="#"><?php echo JText::_('GURU_PRICING_PLANS'); ?></a></li>
                    <li class=""><a href="#"><?php echo JText::_('GURU_DAY_REQ'); ?></a></li>
                </ul>
                <br/>
                ...
                <ul class="uk-switcher" id="subnav-pill-content-1">
                    ...
                    <li>
                        <input type="button" class="uk-button uk-button-primary" onclick="javascript:openMyModal(0, 0, '<?php echo JURI::root();?>index.php?option=com_guru&view=guruauthor&task=addexercise&tmpl=component&cid=<?php echo $program->id;?>'); return false;" value="<?php echo JText::_("GURU_EXERCISE_FILE"); ?>" />
                    ...
                    <div class="container-fluid">
                        <div id="accordion" class="accordion">
                            ...
                            <div class="accordionItem">
                                ...
                                <div class="clearfix tab-body  g_accordion-group g_content_active">
                                    <div style="float:left;">
                                        <a data-toggle="modal" data-target="#myModal" onclick="showContent('<?php echo JURI::root(); ?>index.php?option=com_guru&view=guruauthor&task=addexercise&tmpl=component&cid=<?php echo $program->id;?>')" href="#">
                                      <?php echo JText::_("GURU_EXERCISE_FILE"); ?>
                                      </a>&nbsp;
                                    </div>
                                    <div style="float:left;">
                                        <span class="editlinktip hasTip" title="<?php echo JText::_("GURU_TIP_EXERCISE_FILE"); ?>" >
