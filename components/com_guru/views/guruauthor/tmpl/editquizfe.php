...
<?php
	...
	/*if($deviceType != "phone"){
		...
		if($value_option == 0){
			// regular quiz
			include_once(JPATH_SITE.DIRECTORY_SEPARATOR."components".DIRECTORY_SEPARATOR."com_guru".DIRECTORY_SEPARATOR."views".DIRECTORY_SEPARATOR."guruauthor".DIRECTORY_SEPARATOR."tmpl".DIRECTORY_SEPARATOR."reg_q_phone.php");
		}
		else{
			// final quiz
			include_once(JPATH_SITE.DIRECTORY_SEPARATOR."components".DIRECTORY_SEPARATOR."com_guru".DIRECTORY_SEPARATOR."views".DIRECTORY_SEPARATOR."guruauthor".DIRECTORY_SEPARATOR."tmpl".DIRECTORY_SEPARATOR."final_q_phone.php");
		}
	}*/
?>