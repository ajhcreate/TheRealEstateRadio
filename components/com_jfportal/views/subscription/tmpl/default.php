 ...
 * @subpackage	views.subscription.tmpl.default
 *
...
<div class="modal-body <?php echo $this->item->classname;?>">
	...
	<?php if(isset($this->item->CProgram) && $this->item->CProgram->ProgramName !== null) :?>
	<div class="row-fluid ProgramName">
		<div class="span6 text-right"><?php echo JText::_('COM_JFPORTAL_VIEW_SUBSCRIPTION_SUBSCRIPTION_NAME');?></div>
		<div class="span6"><?php echo ($this->item->CProgram->ProgramName) ? $this->item->CProgram->ProgramName : JText::_('COM_JFPORTAL_VIEW_SUBSCRIPTION_SUBSCRIPTION_NAME_UNKNOWN'); ?></div>
	</div>
	<?php endif;?>
	
	<?php if(isset($this->item->AutoCharge) && $this->item->AutoCharge !== null) :?>
	...
	<?php if(isset($this->item->BillingAmt) && $this->item->BillingAmt !== null) :?>
	...
	<?php if(isset($this->item->BillingCycle) && $this->item->BillingCycle !== null) :?>
	...
	<?php if(isset($this->item->CC1) && $this->item->CC1 !== null) :?>
	...
	<?php if(isset($this->item->LastBillDate) && $this->item->LastBillDate !== null) :?>
	...
	<?php if(isset($this->item->MaxRetry) && $this->item->MaxRetry !== null) :?>
	...
	<?php if(isset($this->item->NextBillDate) && $this->item->NextBillDate !== null) :?>
	...
	<?php if(isset($this->item->NumDaysBetweenRetry) && $this->item->NumDaysBetweenRetry !== null) :?>
	...
	<?php if(isset($this->item->StartDate) && $this->item->StartDate !== null) :?>
	...
	<?php if(isset($this->item->EndDate) && $this->item->EndDate !== null) :?>
	<div class="row-fluid StartDate">
	...
	<?php if(isset($this->item->Status) && $this->item->Status !== null) :?>
	...
	<?php if($this->item->is_editable  && $this->item->Status == JoomfuseTableRecurringOrder::STATUS_ACTIVE):?>
