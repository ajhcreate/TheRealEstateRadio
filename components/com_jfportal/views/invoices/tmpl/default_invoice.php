 ...
 * @subpackage	views.invoices.tmpl.default_invoice
 *
...
<div id="details_<?php echo $this->item->Id; ?>" name="details_<?php echo $this->item->Id; ?>" class="<?php echo $this->params->get('modal_classname','');?>">
	<?php if($this->params->get('show_details_Description',true) && !empty($this->item->Description)) :?>
		<div class="modal-header">
			<h3><?php echo ($this->item->Description); ?></h3>
		</div>
	<?php endif?>
		
	<?php if($this->params->get('show_details_PayStatus',true)):?>
	...
	<?php if($this->params->get('show_details_actions',true) && isset($this->item->PayStatus) && $this->item->PayStatus == JoomfuseTableInvoice::INVOICE_PAY_STATUS_UNPAID ):?>
	   	<div class="">
	        ...
	        <?php else:?>
				<form action="<?php echo JRoute::_('index.php?option=com_jfportal&view=subscriptions')?>" method="post" class="form-inline">
		            ...
		            <div  class="text-center">
		               	<select class="paymentCC" name="cc_id">
